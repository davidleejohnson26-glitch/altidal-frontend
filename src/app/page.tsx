    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-4 pb-24">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 mt-10">
          <div className="lg:col-span-2">
            <Results loading={loading} legs={filtered} onOpen={(l: any) => setSelected(l)} onSaveAlert={() => setShowAlert(true)} />
          </div>
          <div>
      ...
      {toast && (
        <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2">
          <div className={`rounded-full px-4 py-2 shadow-lg ${toast.type === 'ok' ? 'bg-emerald-600 text-white' : 'bg-slate-900 text-white'}`}>
            {toast.text}
          </div>
        </div>
      )}
